...
void listarPantalla(Pantalla* pPantalla, int limite)
{
    ...
    for(i=0;i<limite;i++)
    {
        ...
        {
            printf("Direccion: %s",pPantalla[i].direccion);
            printf("ID: %d",pPantalla[i].id);
            printf("Nombre: %s",pPantalla[i].nombre);
            printf("Precio: %f",pPantalla[i].precio);
            printf("Tipo: %d \n",pPantalla[i].tipo);
        }
    }
}
